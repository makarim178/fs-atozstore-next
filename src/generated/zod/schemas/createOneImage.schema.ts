...
export const ImageCreateOneSchema = z.object({ select: ImageSelectObjectSchema.optional(), include: ImageIncludeObjectSchema.optional(), data: z.union([ImageCreateInputObjectSchema, ImageUncheckedCreateInputObjectSchema])  })