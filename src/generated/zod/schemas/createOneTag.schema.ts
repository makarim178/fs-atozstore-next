...
export const TagCreateOneSchema = z.object({ select: TagSelectObjectSchema.optional(), include: TagIncludeObjectSchema.optional(), data: z.union([TagCreateInputObjectSchema, TagUncheckedCreateInputObjectSchema])  })