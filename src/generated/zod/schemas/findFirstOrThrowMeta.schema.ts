...
export const MetaFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MetaSelect> = z.object({
...
export const MetaFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    created_at: z.boolean().optional(),
    updated_at: z.boolean().optional(),
    barcode: z.boolean().optional(),
...
export const MetaFindFirstOrThrowSchema: z.ZodType<Prisma.MetaFindFirstOrThrowArgs> = z.object({ select: MetaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MetaIncludeObjectSchema.optional()), orderBy: z.union([MetaOrderByWithRelationInputObjectSchema, MetaOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetaWhereInputObjectSchema.optional(), cursor: MetaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetaScalarFieldEnumSchema, MetaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MetaFindFirstOrThrowArgs>;

export const MetaFindFirstOrThrowZodSchema = z.object({ select: MetaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MetaIncludeObjectSchema.optional()), orderBy: z.union([MetaOrderByWithRelationInputObjectSchema, MetaOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetaWhereInputObjectSchema.optional(), cursor: MetaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetaScalarFieldEnumSchema, MetaScalarFieldEnumSchema.array()]).optional() }).strict();