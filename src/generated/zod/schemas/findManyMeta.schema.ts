...
export const MetaFindManySelectSchema: z.ZodType<Prisma.MetaSelect> = z.object({
...
export const MetaFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    created_at: z.boolean().optional(),
    updated_at: z.boolean().optional(),
    barcode: z.boolean().optional(),
...
export const MetaFindManySchema: z.ZodType<Prisma.MetaFindManyArgs> = z.object({ select: MetaFindManySelectSchema.optional(), include: z.lazy(() => MetaIncludeObjectSchema.optional()), orderBy: z.union([MetaOrderByWithRelationInputObjectSchema, MetaOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetaWhereInputObjectSchema.optional(), cursor: MetaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetaScalarFieldEnumSchema, MetaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MetaFindManyArgs>;

export const MetaFindManyZodSchema = z.object({ select: MetaFindManySelectSchema.optional(), include: z.lazy(() => MetaIncludeObjectSchema.optional()), orderBy: z.union([MetaOrderByWithRelationInputObjectSchema, MetaOrderByWithRelationInputObjectSchema.array()]).optional(), where: MetaWhereInputObjectSchema.optional(), cursor: MetaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MetaScalarFieldEnumSchema, MetaScalarFieldEnumSchema.array()]).optional() }).strict();