...
const makeSchema = () => z.object({
  ...
  product_id: z.string().optional()
        ...
        const singles: string[] = ["id","product_id"] as string[];
...
export const UnitDimensionWhereUniqueInputObjectSchema: z.ZodType<Prisma.UnitDimensionWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.UnitDimensionWhereUniqueInput>;
export const UnitDimensionWhereUniqueInputObjectZodSchema = makeSchema();
